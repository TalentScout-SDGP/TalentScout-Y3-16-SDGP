...
class PlayerProfilesTest(unittest.TestCase):
    ...
    def test_tab_navigation(self):
        ...
        searchButton.click()
        time.sleep(7)
        tabs = self.driver.find_element(By.XPATH,"/html/body/div/div/div[3]/div/div[2]/div[2]/div/div/div[1]/div/div/button[2]")
        tabs.click()
    ...
    def test_searching_a_player(self):
        ...
        time.sleep(2)
        select_dropdown = self.driver.find_element(By.XPATH,'/html/body/div/div/div[3]/div/div[1]/div/div/div/div/div/div')
