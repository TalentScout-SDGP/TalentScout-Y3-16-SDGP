    ...
    return (
        <div className="font-poppins">
            <div className="md:container px-8">
                <div
                    className="bg-primary-ts_purple flex flex-col gap-y-16 justify-center items-center rounded-lg p-16">
                    ...
                    <Link to="/compare_players" className="text-xs lg:text-sm front-semibold bg-primary-ts_blue text-white rounded-button px-4 py-1 lg:py-2 shadow-lg
