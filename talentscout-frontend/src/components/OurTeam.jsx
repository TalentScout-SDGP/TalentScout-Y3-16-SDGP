            ...
            <div className="container mx-auto">
                <div className="lg:h-96 my-16 grid lg:grid-cols-2 rounded-lg bg-primary-ts_purple shadow-xl">
                    <div className="flex flex-col justify-center px-6 lg:ps-16">
                        ...
                        <div className="py-4 lg:text-left md:text-sm lg:text-base sm:text-center text-center">
                    ...
                    <div className="flex justify-center items-center px-8">
                        <img src={import.meta.env.BASE_URL + 'All.png'} alt="team"
                             className="rounded-lg lg:w-full pb-6 object-contain h-80 w-96"/>
                    </div>
                </div>

                {/* Member Details */}
                <div
                    className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-4 lg:gap-x-9 gap-y-6 lg:gap-y-11 pb-11 place-items-center">
                    {/* Member 1 */}
                    <div className="transition duration-300 ease-in-out hover:scale-105">
                        <img src={import.meta.env.BASE_URL + 'DulhanMin-1.jpg'} alt="teamleader"
                             className="rounded-lg object-contain h-96 w-96"/>
                    ...
                    {/* Member 2 */}
                    <div className="transition duration-300 ease-in-out hover:scale-105">
                        <img src={import.meta.env.BASE_URL + 'DinukaMin-1.jpg'} alt="Dinuka"
                             className="rounded-lg object-contain h-96 w-96"/>
                    ...
                    {/* Member 3 */}
                    <div className="transition duration-300 ease-in-out hover:scale-105">
                        <img src={import.meta.env.BASE_URL + 'SulanMin-1.jpg'} alt="team"
                             className="rounded-lg object-contain h-96 w-96"/>
                    ...
                    {/* Member 4 */}
                    <div className="transition duration-300 ease-in-out hover:scale-105">
                        <img src={import.meta.env.BASE_URL + 'LinukaMin-1.jpg'} alt="team"
                             className="rounded-lg object-contain h-96 w-96"/>
                    ...
                    {/* Member 5 */}
                    <div className="transition duration-300 ease-in-out hover:scale-105">
                        <img src={import.meta.env.BASE_URL + 'ChamathMin-1.jpg'} alt="team"
                             className="rounded-lg object-contain h-96 w-96"/>
                    ...
                    {/* Member 6 */}
                    <div className=" transition duration-300 ease-in-out hover:scale-105">
                        <img src={import.meta.env.BASE_URL + 'AgraniMin-1.jpg'} alt="team"
                             className="rounded-lg object-contain h-96 w-96"/>
