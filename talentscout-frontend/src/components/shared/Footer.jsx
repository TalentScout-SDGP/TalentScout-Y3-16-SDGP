            ...
            <div className="md:container grid grid-cols-12 py-8 gap-y-8">
                <div
                    ...
                    <div className="flex gap-x-8 items-center md:mt-8 lg:mt-0">
                        ...
                        <a className="self-center transition-transform duration-3000 transform hover:scale-125"
                           href="https://web.facebook.com/people/TalentScout/61557263277778/">
                ...
                <div
                    className="flex lg:gap-y-6 flex-col gap-y-4 md:gap-y-8 text-white col-span-12 lg:col-span-3 md:mt-8 lg:mt-16 lg:ps-0 items-center lg:items-start order-2 lg:order-2">
