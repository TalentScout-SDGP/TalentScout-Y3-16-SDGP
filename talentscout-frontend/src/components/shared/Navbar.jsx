...
const Navbar = () => {
    ...
    return (
        <div className="bg-white shadow-xl font-poppins">
            <div className="md:container flex flex-col lg:flex-row justify-between gap-x-2 lg:items-center p-3">
                ...
                <div
                    ...
                    <Link to="/"
                          className="text-xs xl:text-sm text-black hover:bg-primary-ts_blue hover:text-white p-4 rounded-3xl">
                        Home
                    </Link>
             ...
             hover:bg-white hover:text-primary-ts_blue hover:border-primary-ts_blue hover:border-2 transition-all duration-300 ease-in-out w-fit">
                        Sign Up
                    </Link>
                </div>
            </div>
