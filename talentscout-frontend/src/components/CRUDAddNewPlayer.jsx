                        ...
                        <form className="w-full py-4 lg:py-8">
                            <div className="lg:grid lg:grid-cols-2 lg:pt-8 px-6 lg:px-8">
                                ...
                                <div className="lg:grid lg:grid-cols-2 py-4 text-xs font-semibold">
                                    <div className="mb-5">
                                        <label htmlFor="large-input"
                                               className="block  lg:mb-14 2xl:mb-14 xl:mb-14 md:mb-2 sm:mb-2 mb-2 text-base font-semibold">Date of Birth : </label>
                                    </div>
                                    <div className="mb-5">
                                    ...
                                    border-black focus:outline-none rounded-lg shadow-explore_players text-md font-semibold px-2 py-2">
                                            <option
                                                className="text-primary-ts_blue text-sm md:text-base font-semibold">Right Hand
                                            </option>
                                            <option
                                                className="text-primary-ts_blue text-sm md:text-base font-semibold">Left Hand
                                            </option>
                                        </select>
                                ...
                                <div className="lg:grid lg:grid-cols-2 py-3 lg:px-6 ">
                                    <div className="py-2 text-base font-semibold">
                                        Playing Role :
                                    </div>
                                    <div className="w-full md:mb-10 relative">
                                        <select className="appearance-none cursor-pointer text-sm lg:text-md block w-full bg-white text-black placeholder-primary-light_gray border
                                    border-black focus:outline-none rounded-lg shadow-explore_players text-md font-semibold px-2 mb-6 py-2">
                                            <option
                                            ...
                                            <option
                                                className="text-primary-ts_blue text-sm md:text-base font-semibold">Wicket Keeper
                                            </option>
                                            <option
                                                className="text-primary-ts_blue text-sm md:text-base font-semibold">All Rounder
                                            </option>
                                        </select>
                                        <svg xmlns="http://www.w3.org/2000/svg"
                                             xmlnsXlink="http://www.w3.org/1999/xlink"
                                    ...
                                    <div className="py-2 md:py-3 text-base font-semibold">
                                        Bowling Style :
                                    </div>
                                    <div className="w-full relative">
                                        <select className="appearance-none cursor-pointer text-sm lg:text-md block w-full bg-white text-black placeholder-primary-light_gray border
                                    border-black focus:outline-none rounded-lg shadow-explore_players text-md font-semibold px-2 py-2 my-2">
                                            <option
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg"
                                             xmlnsXlink="http://www.w3.org/1999/xlink"
                                             width="22" height="26" viewBox="2 0 30 18" fill="none"
                                             className="absolute top-2 right-2 cursor-pointer">
                                            <rect width="30" height="26" fill="url(#pattern0)"/>
                                            <defs>
                                                <pattern id="pattern0" patternContentUnits="objectBoundingBox"
