            ...
            <div className="md:container grid sm:grid-cols-1 px-8">
                <div className="lg:flex sm:grid sm:grid-cols-1 md:items-center md:justify-center mx-auto mt-16 px-12 py-10 bg-primary-ts_purple rounded-2xl shadow-xl">
                    <div className="lg:flex lg:flex-col md:grid md:grid-cols-1 text-center md:text-center lg:text-left">
                        ...
                        <p className="lg:mr-60 sm:text-xs md:text-base text-justify pt-12 pb-10">Welcome to
                    ...
                    <img className="size-80 w-full mx-auto 2xl:mx-2 rounded-3xl" src={import.meta.env.BASE_URL + 'about_us.png'} alt=""/>
                </div>

                <div className="mx-auto p-8 mt-8 mb-10">
                    <div className="2xl:space-x-28 lg:flex lg:justify-center items-center lg:space-x-24 sm:text-xs sm:grid sm:grid-cols-1">
                        <a href="">
