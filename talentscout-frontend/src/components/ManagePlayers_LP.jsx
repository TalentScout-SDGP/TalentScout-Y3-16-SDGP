            ...
            <div className="md:container mt-20 mb-20">
                <div className="bg-primary-ts_blue grid grid-cols-1 my-8 shadow-outer rounded-3xl px-10 sm:px-10 py-8">
                    <div className="flex flex-col items-center justify-center">
                        <p className="text-white text-base text-justify lg:p-8 lg:text-lg">
                            The ultimate hub for coaches, team managers and unmatched teams hungry for excellence. With a sleek
                            interface designed for efficiency, users can easily use search, add, update and delete options. This
                            tool allows you to sculpt and fine-tune your team with precision. Experience the power of strategic
                            player management and ensure your roster reflects your vision for victory.
                        </p>
