    ...
    return (
        <div className="font-poppins">
            <div className="md:container px-2 sm:px-8">
                <div
                    className="bg-cover bg-center h-[60vh] md:h-[70vh] lg:h-[80vh] flex items-center justify-center rounded-3xl my-6 md:my-12"
                    ...
                    <div
                        ...
                        <p className="text-white text-base lg:text-xl mb-6">Unleash the power of cricket data with
                        ...
                        <Link to="/explore_players" className="text-sm bg-primary-yellow text-black font-semibold rounded-button px-4 py-1 lg:py-3 shadow-lg border-primary-ts_blue border-2
