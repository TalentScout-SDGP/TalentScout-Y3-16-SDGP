        ...
        <div className="font-poppins">
            <div className="md:container my-8 md:my-12 px-2">
                <div
                    ...
                    <div className="lg:px-6 grid grid-cols-2 md:grid-cols-12 justify-center items-center md:gap-x-4">
                        <div className="text-center md:col-span-3 order-1 md:order-1">
                            ...
                            <p className="mt-6 font-semibold text-black text-sm md:text-base lg:text-lg">{selectedPlayerData.player.full_name}</p>
                        </div>
                        <div
                        ...
                        <div className="text-center md:col-span-3 order-2 md:order-3">
                            <img className="w-3/5 md:w-3/5 lg:w-3/5 mx-auto"
                                 src={import.meta.env.BASE_URL + 'Player-dummy-image.png'}
                                 alt="player-dummy-image"></img>
                            <p className="mt-6 font-semibold text-black text-sm lg:text-lg md:text-base">{selectedSecondPlayerData.player.full_name}</p>
                        </div>
                    </div>
                </div>
            </div>
